...
export class AppContextProvider {
  ...
  notificationsV2 = new Subject<any>();
  ...
  constructor() {
    ...
    this.notificationsV2.subscribe(notifications => {
      this.notificationsV2Collection = notifications;
    })
